Вот полноценный файл `README.md` для вашего проекта на ветке `nextJS`. Этот файл описывает весь процесс установки и запуска проекта, а также его структуру и особенности.
...
Если у вас возникли вопросы или предложения, пожалуйста, откройте Issue или Pull Request в этом репозитории.
...
Теперь этот файл `README.md` предоставляет полное руководство по запуску проекта, как в Docker, так и локально, и описывает структуру проекта и используемые технологии. Если будут дополнительные требования к этому файлу, дайте знать!