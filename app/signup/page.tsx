                    ...
                    <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                        <div className="">
                            ...
                            <div className="mt-5 space-y-2">
                                ...
                                <p className="">Already have an account? <a href="/signin" className="font-medium text-indigo-600 hover:text-indigo-500">Sign in</a></p>
                            </div>
                        </div>
                        ...
                        <div className="mt-5 space-y-2">
                                {/* <h3 className="text-gray-800 text-2xl font-bold sm:text-3xl">Sign up</h3> */}
                                <p className="">You want to leave home page? <a href="/" className="font-medium text-indigo-600 hover:text-indigo-500">Home</a></p>
                            </div>
                    </div>
                </div>
            </main>
